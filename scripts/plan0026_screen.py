...
PLAN = "docs/plans/active/0026-two-forward-orthogonal-hunters-screen.md"
DATA = (
    "experiments/proposals/"
    "three-runners-two-forward-orthogonal-hunters-v0.json"
)
PROTOCOL = "plan0026-two-forward-orthogonal-hunters-v1"
HASH = "aed723e270cacd8bdfe3c87db22299d8ccf1045e63c0cebbd638d900d0491b94"
EXPOSURE = (
...
CELLS = (
    ("base", "T4", "T4", 700, 16),
    ("base", "T3", "T3", 700, 16),
    ("confirm", "T4", "T4", 800, 16),
    ("sensitivity", "T4", "T2", 800, 8),
    ("sensitivity", "T2", "T4", 800, 8),
    ("simple", "T4", "R", 800, 8),
    ("simple", "R", "T4", 800, 8),
)
