...
PLAN = "docs/plans/active/0025-staggered-orthogonal-hunters-screen.md"
DATA = (
    "experiments/proposals/"
    "three-runners-two-staggered-orthogonal-hunters-v0.json"
)
PROTOCOL = "plan0025-staggered-orthogonal-hunters-v1"
HASH = "90b7f9e8f763183e8034b9c387ed8fa46f2150be21d044a135d8f3fefa3745ab"
...
CELLS = (
    ("base", "T4", "T4", 500, 16),
    ("base", "T3", "T3", 500, 16),
    ("confirm", "T4", "T4", 600, 16),
    ("sensitivity", "T4", "T2", 600, 8),
    ("sensitivity", "T2", "T4", 600, 8),
    ("simple", "T4", "R", 600, 8),
    ("simple", "R", "T4", 600, 8),
)
