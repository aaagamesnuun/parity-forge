"""Bounded audit adapters for Plan 0024 around the public game loop.
...
class _AuditAgent:
    ...
    def total_nodes(self):
        # RandomAgent performs real selection work but exposes no node meter.
        return 0 if self.policy == "R" else self.underlying.total_nodes
    ...
    def select_action(self, definition, state, choices, rng):
        ...
        try:
            ...
            if type(choices) is not tuple or choices != canonical_choices:
